      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-start gap-10 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <div className="flex items-center space-x-3">
            <h2 className="text-xl font-bold">Via Phone</h2>
            <FaMobileAlt />
            <a
              href="tel:+447776632365"
          ...
          <div className="flex items-center space-x-3">
            ...
            <FaEnvelope />
            <a
              href="mailto:teja9509@gmail.com"
              className="font-bold hover:text-blue-400"
            >
              teja9509@gmail.com
            </a>
          ...
          <div className="flex items-center space-x-3">
            <h2 className="text-xl font-bold">Via LinkedIn</h2>
            <FaLinkedin />
            <a
              href="https://linkedin.com/in/tejac15"
              target="_blank"
        ...
        {/* Right - Contact Form */}
        <div className="w-full md:w-1/2 bg-transparent text-white rounded-lg shadow-lg p-4">
